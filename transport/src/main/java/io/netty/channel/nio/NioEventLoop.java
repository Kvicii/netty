...
public final class NioEventLoop extends SingleThreadEventLoop {
    ...
    private SelectorTuple openSelector() {
        ...
        // 将SelectedKeySet保存到成员变量中 之后每次Selector操作结束之后如果有IO事件都会把对应的SelectionKey塞到该集合 直接对该集合处理
            ...
            try {
                ...
                if (ioRatio == 100) {
                    ...
                    try {
                        ...
                        // Ensure we always run tasks.
                        final long ioTime = System.nanoTime() - ioStartTime;    // 记录开始时间
    ...
    private void processSelectedKeys() {
        if (selectedKeys != null) { // SelectedKeys成员变量就是经过优化之后的结构
            // 不使用JDK的selector.selectedKeys 性能优于1%~2% 垃圾回收更少
